...
import com.example.library.adapters.BookListAdapter
import com.example.library.models.Book
import com.example.library.utils.BookHttp
...
class BooksListFragment: Fragment() {
    ...
    private fun showProgress(show: Boolean){
        if(show){
            textView.setText(R.string.message_progress)
        }
    ...
    private fun updateBookList(result: List<Book>?){
        if(result != null){
            ...
            textView.setText(R.string.error_load_books)
        }
